...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    isPlaceholder: false,
    funFact:
      "요즘 어린이들의 문해력과 독해력이 현저히 낮아지고 있다는 사실, 알고 계셨나요? 기우가 아니라 현실이랍니다.<br><br><strong>책놀이터</strong>는 광역 밴쿠버에서 쉽게 만나보기 힘든 <strong>어린이 전집 대여 서비스</strong>를 통해, 아이들이 자연스럽게 <strong>책과 가까워질 수 있는 환경</strong>을 만들어가고 있어요. 오늘 밤은 스크린 말고 책과 함께하는 건 어떨까요? <br><br>저는 요즘 월든을 즐겨 읽는답니다. 여러분은 무엇을 읽고 계세요?",
  },
  {
    id: 7,
    name: "기업명",
