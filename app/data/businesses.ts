...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    isPlaceholder: false,
    funFact:
      "옛날부터 아기가 100일을 무사히 넘기는 것을 큰 축복으로 여겼습니다. 그래서 단순한 축하를 넘어서 가족뿐 아니라 이웃과 음식을 나누는 ‘공동 축하’ 문화가 발달했죠. <strong>The Party Ave</strong>는 백일상, 돌상, 패밀리 이벤트 전문 업체로 밴쿠버 지역에서 특별한 날을 더욱 빛나게 만들어 드리고 있답니다! 아이의 100일을 미리 축하드려요!",
  },
  {
    like: Math.floor(Math.random() * 1000),
    id: 11,
