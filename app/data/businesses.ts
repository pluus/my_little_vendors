...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    isPlaceholder: false,
    funFact:
      "<strong>버터 옐로우 클럽</strong>의 케이크는 제겐 정말 특별해요! 케이크를 정말 싫어하는 사람을 한 명 알고 있어요. 생일에도 케이크는 거들떠보지 않고 빵만 조금 먹던 사람이었는데, 버터 옐로우 클럽 케이크는 ”괜찮네?” 하더니 포크로 푹푹 잘라 먹더라고요. 접시가 깔끔하게 비워진 모습은 난생 처음 봤답니다. 모두가 놀라워 했어요. 비결이 뭐였을까요?",
  },
  {
    id: 8,
    name: "기업명",
