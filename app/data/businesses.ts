...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    name: "Flora Piano",
    description:
      "RCM 8급, 음악영어전문가·영어로 배우는 피아노·아동/기초 피아노 지도법, Piano Adventures 전문교사, 문화예술교육사 2급 보유.<br><br>초등학교 방과후 출강 경력 있으며, 100대 피아노 연주 및 다수의 연주회·콩쿠르 수상 및 참가 이력 보유. <br><br>대구가톨릭대학교 피아노과 졸업 및 다양한 공연 활동 경험을 바탕으로 전문적인 피아노 교육을 제공합니다.",
    category: "음악",
    location: "버나비",
    tags: ["음악", "피아노", "레슨", "개인 레슨", "그룹 레슨"],
