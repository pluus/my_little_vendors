...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    isPlaceholder: false,
    funFact:
      "참기름 한 방울에도 진짜 통참깨만! CHARM OIL은 0% 첨가물, 100% 통참깨만 사용해요. “대량 생산”보다 “갓 만든 신선함”을 선택했어요. 주문 후 정성껏 생산해 더 고소하고 신선해요. BC 주정부 정식 허가를 받은 오일 전문 생산 업체예요. 믿고 먹을 수 있는 라이센스 커머셜 키친에서 만들어져요. 내 가족과 아이에게 먹이고 싶은 마음으로 만들어요. 그래서 청결과 원재료 기준이 깐깐해요. 참깨를 아낌없이 사용해 고소한 향이 진하고 깊어요. 첨가물 없이도 맛있는 이유? 좋은 참깨와 신선도가 답이에요 ✨ 한 병 한 병, 공장에서 찍어내듯 만들지 않아요. 주문 즉시 정성을 담아 생산해요. “깨부터 다르다”는 말을 듣는 이유 🙂 통참깨 그대로 사용해 풍미가 살아있어요.",
  },
  {
    id: 9,
    name: "기업명",
