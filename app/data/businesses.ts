...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    isPlaceholder: false,
    funFact:
      "<strong>Cake Leon</strong>의 케이크를 보셨나요? 조그만 10인치 남짓한 공간에서 벌어지는 아름다운 디자인과 환상적인 맛.<br><br>단호박, 인절미, 흑임자 같은 다소 낯선 재료가 케이크와 절묘하게 어울릴 줄이야! 정말 깜짝 놀랐어요!<br><br>다이어트 중인데 정말 참기가 어렵네요 😭. 딱 한입은 괜찮겠죠?",
  },
  {
    id: 19,
    like: Math.floor(Math.random() * 1000),
