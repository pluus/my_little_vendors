...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    isPlaceholder: false,
    funFact:
      "케이크를 정말 싫어하는 사람을 한 명 알고 있어요. 생일에도 케이크는 거들떠보지 않고 빵만 조금 먹던 사람이었는데, 그런데도 <strong>버터 옐로우 클럽</strong> 케이크는 “이건 괜찮네?” 하더니 포크로 푹푹 잘라 먹더라고요. 접시가 깔끔하게 비워진 모습은 난생 처음 봤답니다. 그만큼 맛있다는 뜻이겠죠?",
  },
  {
    id: 8,
    name: "기업명",
