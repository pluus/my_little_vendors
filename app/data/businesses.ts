...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    isPlaceholder: false,
    funFact:
      "풍선아트는 생각보다 고도의 기술이 필요해요. 꽃, 동물, 캐릭터, 대형 장식까지 만들기 위해서는 색 조합, 구조 설계, 공간 디자인 능력이 모두 필요하답니다. <br><br><strong>Flodeer</strong>의 작품들은 미술 전공자의 감각과 섬세한 손길이 더해져 특별한 순간을 더욱 아름답게 꾸며준답니다! 여러분도 특별한 날에 풍선아트로 게스트와 함께 즐거운 추억을 만들어보시는건 어떨까요? 🎈🌸",
  },
  {
    like: Math.floor(Math.random() * 1000),
    id: 12,
